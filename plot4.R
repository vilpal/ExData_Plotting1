...
setwd('C:/Users/PVill_000/Documents/Explanatory data analysis/exdata_data_household_power_consumption')
...
#create canvas of 4 graphs
par(mfrow = c(2, 2), mar = c(4, 4, 4, 4), oma = c(0, 0, 0, 0))

#create histrogram plot
plot(y=as.numeric(subset$Global_active_power),x=(subset$Date), ylab='Global Active Power',xlab='', main='', type='l')
#create time series line graph
plot(y=as.numeric(subset$Voltage),x=(subset$Date), ylab='Voltage',xlab='datetime', main='', type='l')
...
#create time series line graph
plot(y=as.numeric(subset$Global_reactive_power),x=(subset$Date), ylab='Global_reactive_power',xlab='datetime', main='', type='l')
